...
{
    [SerializeField] Pools[] enemyPools;
    [SerializeField] Pools[] Weapon;
    [SerializeField] Pools[] enemyProjectilePools;
    [SerializeField] Pools[] VFX;
    [SerializeField] Pools[] Item;
    static Dictionary<GameObject, Pools> dictionary;
    void Awake()
    {
        dictionary = new Dictionary<GameObject, Pools>();
    ...
    void OnDestroy()
    {
        ...
        CheckPoolSize(Weapon);
        CheckPoolSize(enemyProjectilePools);
        CheckPoolSize(VFX);
        CheckPoolSize(Item);
    }
    #endif
    void CheckPoolSize(Pools[] pools)
    {
...
#endif
        GameObject releasedObject = dictionary[prefab].PreparedObject();

#if UNITY_EDITOR
        if (releasedObject == null)
        {
            Debug.LogWarning("Released object is null. Check object pool implementation.");
        }
#endif
